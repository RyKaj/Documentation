...
It is the most basic type of database that can be used as collections, arrays, dictionaries, etc. It helps developers to store the schema-less data. It works best for shopping cart content.
...
Here, we have listed the major benefits of the NoSQL database but there a few more as discussed by enterprises like easy to implement, easy to  use, supports multiple languages & platforms, thriven open source community, etc.

## NoSQL - Couchbase or Mongo

<img src="./attachments/463529689.png" />
