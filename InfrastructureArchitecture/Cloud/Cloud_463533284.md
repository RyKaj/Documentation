...
<kbd>![](https://miro.medium.com/max/963/1*F_EB3zGRdsahx01e8nLW4w.png){height="250"}
...
**4 Main Cloud Deployment**
 ...
 {.panelContent}
<kbd>![](https://qph.fs.quoracdn.net/main-qimg-34fbe07d9311be4084f7b7b8a502a307){height="250"} 
<kbd>![](https://erpsoftwareblog.com/cloud/wp-content/uploads/4-Primary-Cloud-Deployment-Models-Infographic-Turnkey-Technologies1.png){height="400"}
...
<kbd>![](https://www.sam-solutions.com/blog/wp-content/uploads/2017/08/a-cloud-provider@2x.png){height="250"}
...
<kbd>![](https://www.sam-solutions.com/blog/wp-content/uploads/2017/08/a-private-cloud@2x.png){width="230"
height="250"}
...
<kbd>![](https://www.sam-solutions.com/blog/wp-content/uploads/2017/08/hybrid-cloud@2x.png){height="250"}
...
<kbd>![](https://www.sam-solutions.com/blog/wp-content/uploads/2017/08/community-cloud@2x.png){height="250"}
...
|||
|--- |--- |
|<kbd>![Community Cloud](http://www.cloudcomputingpatterns.org/icons/community_cloud_icon.png) |How can the cloud properties – on demand self-service, broad network access, pay-per-use, resource pooling, and rapid elasticity – be provided to exclusively to a group of customers forming a community of trust?|
...
|||
|--- |--- |
|<kbd>![UnpredictableWorkload](http://www.cloudcomputingpatterns.org/icons/continuously_changing_workload_icon.png)|How can a continuous growth or decline in utilization be characterized and how can applications experiencing this workload benefit from cloud computing?|
...
|||
|--- |--- |
|<kbd>![Hybrid Cloud](http://www.cloudcomputingpatterns.org/icons/hybrid_cloud_icon.png)|How can the cloud properties – on demand self-service, broad network access, pay-per-use, resource pooling, and rapid elasticity – be provided to exclusively to a group of customers forming a community of trust?|
...
|||
|--- |--- |
|<kbd>![Infrastructure as a Service (IaaS)](http://www.cloudcomputingpatterns.org/icons/infrastructure_as_a_service_icon.png)|How can different customers share a physical hosting environment so that it can be used on-demand with a pay-per-use pricing model?|
...
<kbd>![Infrastructure as a Service
...
|||
|--- |--- |
|<kbd>![Platform as a Service (PaaS)](http://www.cloudcomputingpatterns.org/icons/platform_as_a_service_icon.png)|How can custom applications of the same customer or different customers share an execution environment so that it can be used on-demand with a pay-per-use pricing model?|
...
|||
|--- |--- |
|<kbd>![Software as a Service (SaaS)](http://www.cloudcomputingpatterns.org/icons/software_as_a_service_icon.png)|How can customers share a provider-supplied software application so that it can be used on-demand with a pay-per-use pricing model?|
...
|||
|--- |--- |
|<kbd>![Once-in-a-lifetime Workload](http://www.cloudcomputingpatterns.org/icons/once_in_a_lifetime_workload_icon.png)|How can equal utilization with a one-time peak be characterized and how can applications experiencing this workload benefit from cloud computing?|
...
|||
|--- |--- |
|<kbd>![Periodic Worload](http://www.cloudcomputingpatterns.org/icons/periodic_workload_icon.png)|How can a periodically peaking utilization over time be characterized and how can applications experiencing this workload benefit from cloud computing?|
...
enabling elastic use of a static resource pool as good as possible.
 ...
 |||
|--- |--- |
|<kbd>![Private Cloud](http://www.cloudcomputingpatterns.org/icons/private_cloud_icon.png)|How can the cloud properties – on demand self-service, broad network access, pay-per-use, resource pooling, and rapid elasticity – be provided in environments with high privacy, security and trust requirements?|
...
|||
|--- |--- |
|<kbd>![Public Cloud](http://www.cloudcomputingpatterns.org/icons/public_cloud_icon.png)|How can the cloud properties – on demand self-service, broad network access, pay-per-use, resource pooling, and rapid elasticity – be provided to a large customer group?|
...
|||
|--- |--- |
|<kbd>![Static Workload](http://www.cloudcomputingpatterns.org/icons/static_workload_icon.png)|How can an equal utilization be characterized and how can applications experiencing this workload benefit from cloud computing?|
...
|||
|--- |--- |
|<kbd>![Unpredictable Workload](http://www.cloudcomputingpatterns.org/icons/unpredictable_workload_icon.png)|How can random and unforeseeable utilization be characterized and how can applications experiencing this workload benefit from cloud computing?|
...
|||
|--- |--- |
|<kbd>![Elastic Infrastructure](http://www.cloudcomputingpatterns.org/icons/elastic_infrastructure_icon.png)|How do Cloud Offerings providing infrastructure resources behave and how should they be used in applications?|
...
| <kbd>![Elastic                        | providing Execution Environments |
...
| <kbd>![Environment-based               | availability in an                |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can providers express       |
| <kbd>![Node-based                     | availability in a node-centric   |
...
| <kbd>![Execution                      | components share a hosting       |
...
| <kbd>![Hype                            | has been abstracted from physical |
...
<kbd>![Hypervisor](http://www.cloudcomputingpatterns.org/sketches/hypervisor_sketch.png){.confluence-embedded-image
.confluence-external-resource}
...
| <kbd>![Map                            | complex processing of large data |
...
| <kbd>![Block                           | accessed as a local drive by      |
...
| <kbd>![Blob                           | organized and made available     |
...
| <kbd>![Eventual                        | among replicas with focus on      |
...
| <kbd>![Key-Value                      | stored to support scale out and  |
...
| <kbd>![Relational                     | so that relations between them   |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can data be distributed     |
| <kbd>![Strict                         | among replicas to increase       |
...
| <kbd>![At-least-once                  | or a Message-oriented Middleware |
...
| <kbd>![Exactly-once                   | message is delivered only        |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can communication partners  |
| <kbd>![Message-oriented               | exchange information             |
...
| <kbd>![Timeout-based                  | messages are only deleted from a |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can it be ensured that      |
| <kbd>![Transaction-based              | messages are only deleted from a |
...
| <kbd>![Virtual                        | between IT resources hosted in a |
...
| <kbd>![Application Component           | be accessed if direct access to   |
...
| <kbd>![Batch Processing               | requests be delayed to be        |
...
| <kbd>![Data                           | data be presented, so that       |
...
| <kbd>![Data Access                    | storage due to access protocols  |
...
| <kbd>![Dedicated                      | that cannot be shared be         |
...
| <kbd>![Distributed                    | functionality be decomposed to   |
...
| <kbd>![Idempotent                     | component cope with message      |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can application components  |
| <kbd>![Integration                    | that reside in different         |
...
| <kbd>![Loose                          | Distributed Applications and     |
...
| <kbd>![Message                        | different providers be           |
...
| <kbd>![Multi-Component                 | the functionality of multiple     |
...
| <kbd>![Processing                     | out elastically among            |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can an application          |
| <kbd>![Restricted Data Access         | component alter provided data    |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can an application          |
| <kbd>![Shared                         | component be shared between      |
...
| <kbd>![Stateful                       | that are scaled-out maintain a   |
...
| <kbd>![Stateless                      | robustness of an application     |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can an application          |
| <kbd>![Tenant-isolated                | component be shared between      |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can an application          |
| <kbd>![Transaction-based              | component ensure that all        |
...
| <kbd>![Timeout-based Message           | messages while guaranteeing that  |
...
| <kbd>![User Interface                 | Components be accessed           |
...
| <kbd>![Elastic Load                   | application component instances  |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can the number of required  |
| <kbd>![Elastic                        | application component instances  |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can the number of required  |
| <kbd>![Elasticity                     | application component instances  |
...
| <kbd>![Elasticity Management          | to which application components  |
...
| <kbd>![Feature Flag Management        | application degrade gracefully,  |
...
| <kbd>![Managed                        | scaled out application component |
...
| <kbd>![Provider                       | application component on a       |
...
| <kbd>![Resiliency Management          | availability of an application   |
...
| <kbd>![Standby Pooling                | times for application component  |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can application components  |
| <kbd>![Update Transition              | of a Distributed Application be  |
...
| <kbd>![Wat                            | automatically detect failing     |
...
<kbd>![Watchdog](http://www.cloudcomputingpatterns.org/sketches/watchdog_sketch.png){.confluence-embedded-image
.confluence-external-resource}
...
| <kbd>![Content Distribution           | application be ensured for a     |
...
| <kbd>![Hybrid Application             | of an application be distributed |
...
| <kbd>![Hybrid                         | that experience varying workload |
...
| <kbd>![Hybrid                         | remote environment while the     |
...
| <kbd>![Hybrid                         | functionality that experiences   |
...
| <kbd>![Hybrid Development              | different computing environments  |
...
| <kbd>![Hybrid\_Multimedia\_Web\       | be integrated efficiently in a   |
...
<kbd>![Hybrid\_Multimedia\_Web\_Application](http://www.cloudcomputingpatterns.org/sketches/hybrid_multimedia_web_application_sketch.png){.confluence-embedded-image
.confluence-external-resource}
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can Processing Components   |
| <kbd>![Hybrid                         | that experiences varying         |
...
| <kbd>![Hybrid User                     | asynchronous interaction be       |
...
| <kbd>![Three-Tier Cloud                | business logic, and data handling |
...
+----------------------------------+----------------------------------+
|  {.content-wrapper}           | *How can application             |
| <kbd>![Two-Tier Cloud                 | functionality be separated from  |
...
<kbd><img src="./attachments/463533288.png" alt="">
...
<kbd><img src="./attachments/463533415.jpg" alt="">
...
<kbd>![](attachments/463533293/463533292.png){.confluence-embedded-image
...
<kbd><img src="./attachments/463533295.png" alt="">{.confluence-embedded-image
...
<kbd><img src="./attachments/463533296.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533299.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533300.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533303.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533306.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533307.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533310.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533313.png" alt="">
...
<kbd><img src="./attachments/463533316.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533317.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533318.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533327.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533329.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533331.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533333.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533335.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533346.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533348.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533349.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border
<kbd>![New-API-GW-Diagram](https://d1.awsstatic.com/serverless/New-API-GW-Diagram.c9fc9835d2a9aa00ef90d0ddc4c6402a2536de0d.png){height="150"}<kbd>![](https://microservices.io/i/apigateway.jpg)
<kbd><img src="./attachments/463533529.png" alt="">
<kbd><img src="./attachments/463533530.png" alt="">
...
<kbd><img src="./attachments/463533351.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533353.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533355.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533356.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533358.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533360.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533361.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533362.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533363.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533364.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533365.png" alt="">{.confluence-embedded-image
height="250"}
...
<kbd><img src="./attachments/463533368.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533383.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533384.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533385.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533387.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533388.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533390.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533392.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533394.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533396.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533398.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}

In the queue, messages for different categories may be interleaved, as
shown in the following diagram:

<kbd><img src="./attachments/463533399.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533401.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533402.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533403.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533405.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533408.png" alt="">{.confluence-embedded-image
.confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533410.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533411.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
<kbd><img src="./attachments/463533413.png" alt="">{.confluence-embedded-image
.confluence-thumbnail .confluence-content-image-border height="150"}
...
[<kbd>![](rest/documentConversion/latest/conversion/thumbnail/463534169/1){height="150"}](/download/attachments/463533284/ebook%20-%20The%20Developer%27s%20Guide%20to%20Azure.pdf?version=1&modificationDate=1585167255007&api=v2){.confluence-embedded-file}

[<kbd>![](rest/documentConversion/latest/conversion/thumbnail/463534171/1){height="150"}](/download/attachments/463533284/Git%20guide-to-the-cloud.pdf?version=1&modificationDate=1585167261247&api=v2){.confluence-embedded-file}

[<kbd>![](rest/documentConversion/latest/conversion/thumbnail/469106904/1){height="150"}](/download/attachments/463533284/eBook%20-%20Cloud%20Migration%20Essentials.pdf?version=1&modificationDate=1586257867787&api=v2){.confluence-embedded-file}
