...
You are developing a large, complex application and want to use the 
...
the Single Responsibility Principle ([SRP](http://www.objectmentor.com/resources/articles/srp.pdf)).
...
such as  *Product/Service development*,  *Product/Service delivery*, 
